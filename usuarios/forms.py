# Importa validadores de Django.
from django.core import validators
# Importa clases y formularios necesarios de Django.
from django import forms
from django.contrib.auth.forms import UserCreationForm
from django.contrib.auth.models import User
# Importa modelos de la aplicación usuarios.
from usuarios.models import UserProfile, Rol, TipoSolicitud, Detallesolicitud, Tipodocumento
# Define un formulario de registro de usuario que hereda de UserCreationForm de Django.
